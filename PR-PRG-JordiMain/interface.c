...
void showClientMenu() {
    ...
    printf("\t7. Give a voyage\n");
    printf("\t8. Cancel ticket\n");
    printf("\t9. Exit\n");
}

void executeClientMenu(int option,DataUsers* data_users, VoyageData* voyage_data, DataSpaceship stock, int user_idx) {
    ...
    case 5:
        *voyage_data=buyTicket(*voyage_data);
        break;
    case 6:
        *voyage_data = rateVoyage(*voyage_data,*data_users,user_idx);
        break;
     case 7:
         *voyage_data = giveVoyage(*voyage_data, *data_users, user_idx);
         break;
     case 8:
         break;
    case 9:
